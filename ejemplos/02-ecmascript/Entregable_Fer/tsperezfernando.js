...
function operacion(a, b, operacion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (operacion == 'suma') {
                let clase = yield Promise.resolve().then(() => __importStar(require('./suma')));
                let sumar = new clase.Suma(a, b);
                resultado = sumar.resultado();
            }
            else if (operacion == 'resta') {
                let clase = yield Promise.resolve().then(() => __importStar(require('./resta')));
...
function operaciones() {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(yield operacion(86, 18, 'suma'));
        console.log(yield operacion(55, 15, 'resta'));
    });
}
operaciones();
